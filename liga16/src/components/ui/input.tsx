  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Foco neutro: sin naranja — el borde se oscurece y anillo apenas visible
        "focus-visible:border-foreground/30 focus-visible:ring-foreground/10 focus-visible:ring-2",
