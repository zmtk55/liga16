  ...
  return (
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Resumen del circuito — gestión de torneos, clubes y contenido. El área valida RLS cuando Supabase está configurado; en demo todo es local.</p>
      </header>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm flex items-center gap-2"><Building2 className="h-4 w-4" /> Clubes</CardTitle></CardHeader><CardContent><p className="text-2xl font-bold">{stats?.c ?? "—"}</p><p className="text-xs text-muted-foreground">Sedes</p></CardContent></Card>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-1">
          ...
          <p>• Operativo: este panel admin con torneos/clubes/noticias, tablas y acciones demo listas para conectar a Supabase RLS.</p>
