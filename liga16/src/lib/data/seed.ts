...
export const players: PlayerProfile[] = [
  { id: 'p-1', user_id: 'u-1', display_name: 'Diego Fuentes', username: 'diegofuentes', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'M', declared_level: 4.5, official_level: 4.6, dominant_hand: 'right', preferred_position: 'drive', bio: 'Compitiendo en el padel Reforma desde 2024.', is_public: true },
  ...
  { id: 'p-3', user_id: 'u-3', display_name: 'Sofía Camacho', username: 'sofiacamacho', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'F', declared_level: 5.0, official_level: 5.2, dominant_hand: 'right', preferred_position: 'reves', bio: 'Buscando pareja para la liga de otoño en Reforma.', is_public: true },
  { id: 'p-4', user_id: 'u-4', display_name: 'Andrés Valle', username: 'andresvalle', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'M', declared_level: 4.0, official_level: 4.1, dominant_hand: 'right', preferred_position: 'both', bio: null, is_public: true },
  ...
  { id: 'p-6', user_id: 'u-6', display_name: 'Emilio Garza', username: 'emiliogarza', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'M', declared_level: 5.5, official_level: 5.4, dominant_hand: 'right', preferred_position: 'drive', bio: 'Capitán de Reforma Smash.', is_public: true },
  { id: 'p-7', user_id: 'u-7', display_name: 'Valeria Montes', username: 'valeriamontes', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'F', declared_level: 3.5, official_level: 3.6, dominant_hand: 'left', preferred_position: 'reves', bio: null, is_public: true },
  { id: 'p-8', user_id: 'u-8', display_name: 'Javier Quintana', username: 'javierquintana', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'M', declared_level: 4.0, official_level: 4.0, dominant_hand: 'right', preferred_position: 'drive', bio: null, is_public: true },
  ...
  { id: 'p-10', user_id: 'u-10', display_name: 'Paola Suárez', username: 'paolasuarez', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'F', declared_level: 4.5, official_level: 4.7, dominant_hand: 'right', preferred_position: 'both', bio: null, is_public: true },
  { id: 'p-11', user_id: 'u-11', display_name: 'Ricardo Anaya', username: 'ricardoanaya', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'M', declared_level: 3.5, official_level: 3.4, dominant_hand: 'right', preferred_position: 'drive', bio: null, is_public: true },
  { id: 'p-12', user_id: 'u-12', display_name: 'Daniela Cervantes', username: 'danielacervantes', photo_url: null, city: 'Ciudad de México', state: 'CDMX', country: 'México', birth_date: null, sex: 'F', declared_level: 4.0, official_level: 4.0, dominant_hand: 'right', preferred_position: 'reves', bio: null, is_public: true },
];
